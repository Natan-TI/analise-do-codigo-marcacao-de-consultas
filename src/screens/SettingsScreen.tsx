...
// Permite ao usuário gerenciar preferências como notificações e backups automáticos, 
// visualizar informações de armazenamento, criar backups, limpar cache e até mesmo 
// apagar todos os dados da aplicação (ações perigosas). 
// Utiliza AsyncStorage e um serviço de storage centralizado.
...
// Estrutura das configurações armazenadas
...
const SettingsScreen: React.FC = () => {
  ...
  // Estados para configurações e status da tela
  ...
  // Carrega configurações e informações de armazenamento
  ...
  return (
    <Container>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {/* Ações relacionadas a backup e cache */}
        <Button
          title="Criar Backup"
