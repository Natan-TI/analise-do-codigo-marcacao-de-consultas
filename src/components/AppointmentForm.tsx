 ...
 * Responsabilidade: Formulário para agendamento de consulta.
 * Fluxo: usuário seleciona médico → insere data → escolhe horário → descreve consulta → envia via onSubmit.
 * Por quê: centraliza a lógica de entrada de dados da consulta e validação antes do agendamento.
 */
...
// ===== Função utilitária: gera intervalos de 30min entre 9h e 18h =====
...
const AppointmentForm: React.FC<AppointmentFormProps> = ({ onSubmit }) => {
   ...
   // ===== Valida se a data digitada é válida e no intervalo permitido (até 3 meses à frente) =====
   ...
   // ===== Formata a data digitada (DD/MM/AAAA) enquanto o usuário escreve =====
   ...
   // ===== Verifica disponibilidade do horário (placeholder para lógica futura) =====
   const isTimeSlotAvailable = (time: string) => {
      // Exemplo: verificar se já existe consulta nesse horário
      return true;
   };
